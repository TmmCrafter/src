...
public class EntityTorretaBasica extends EntityCreature implements IRangedAttackMob{

	public EntityTorretaBasica(World par1World) {
		super(par1World);
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, new EntityAIArrowAttack(this, 0.0D, 2, 2, 40.0F));
		this.tasks.addTask(3, new EntityAIWander(this, 1.0D));
		this.tasks.addTask(4, new EntityAIWatchClosest(this, EntityMob.class, 40.0F));
	...
	this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(15.0F);
	...
	public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_,
			float p_82196_2_) {
		EntityBala entityarrow = new EntityBala(this.worldObj, this, p_82196_1_, 1.6F, (float)(10 - this.worldObj.difficultySetting.getDifficultyId() * 4));
