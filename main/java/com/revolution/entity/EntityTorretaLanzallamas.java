...
public class EntityTorretaLanzallamas extends EntityCreature implements IRangedAttackMob{

	public EntityTorretaLanzallamas(World par1World) {
		super(par1World);
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, new EntityAIArrowAttack(this, 0.0D, 1, 2, 40.0F));
		this.tasks.addTask(3, new EntityAIWander(this, 1.0D));
		this.tasks.addTask(4, new EntityAIWatchClosest(this, EntityMob.class, 10.0F));
    ...
    this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(5.0F);
	...
	public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_,
			float p_82196_2_) {
		EntityFuego entityarrow = new EntityFuego(this.worldObj, this, p_82196_1_, 1.6F, (float)(10 - this.worldObj.difficultySetting.getDifficultyId() * 4));
        int i = EnchantmentHelper.getEnchantmentLevel(Enchantment.power.effectId, this.getHeldItem());
        int j = EnchantmentHelper.getEnchantmentLevel(Enchantment.punch.effectId, this.getHeldItem());
        entityarrow.setDamage((double)(p_82196_2_ * 1.0F) + this.rand.nextGaussian() * 0.25D + (double)((float)this.worldObj.difficultySetting.getDifficultyId() * 0.11F));
