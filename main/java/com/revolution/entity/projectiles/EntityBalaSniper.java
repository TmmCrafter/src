...
public class EntityBalaSniper extends Entity implements IProjectile
{
    ...
    public EntityBalaSniper(World par1World)
    {
    	super(par1World);
    ...
    public EntityBalaSniper(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityBalaSniper(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityBalaSniper(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            else
            {
                ...
                this.ticksInGround = 0;
                this.ticksInAir = 0;
                this.worldObj.spawnParticle("fire", this.posX - this.motionX * (double)0.35, this.posY - this.motionY * (double)0.25, this.posZ - this.motionZ * (double)0.25, this.motionX, this.motionY, this.motionZ);
            }
        }
        else
        {
