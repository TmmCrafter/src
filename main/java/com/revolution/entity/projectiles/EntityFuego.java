package com.revolution.entity.projectiles;
...
public class EntityFuego extends Entity implements IProjectile
{
    ...
    public EntityFuego(World par1World)
    {
    	super(par1World);
    ...
    public EntityFuego(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
        this.setPosition(par2, par4, par6);
        this.worldObj.spawnParticle("bubble", this.posX - this.motionX * (double)0.35, this.posY - this.motionY * (double)0.25, this.posZ - this.motionZ * (double)0.25, this.motionX, this.motionY, this.motionZ);
        this.yOffset = 0.0F;
    }

    public EntityFuego(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityFuego(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            /*this.worldObj.spawnParticle("flame", this.posX, this.posY, this.posZ, 0.00D, 0.00D, 0.00D);
            this.worldObj.spawnParticle("flame", this.posX, this.posY, this.posZ, 0.00D, 0.00D, 0.00D);
            this.worldObj.spawnParticle("flame", this.posX, this.posY, this.posZ, 0.00D, 0.00D, 0.00D);
            this.worldObj.spawnParticle("flame", this.posX, this.posY, this.posZ, 0.00D, 0.00D, 0.00D);
            this.worldObj.spawnParticle("flame", this.posX, this.posY, this.posZ, 0.00D, 0.00D, 0.00D);
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                    {
                        ...
                        this.playSound("", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
            ...
            this.func_145775_I();
                ...
                this.worldObj.spawnParticle("flame", this.posX + 0.1D, this.posY + 0.1D, this.posZ + 0.1D, this.motionX , this.motionY, this.motionZ);
                this.worldObj.spawnParticle("flame", this.posX + 0.1D, this.posY - 0.1D, this.posZ + 0.1D, this.motionX , this.motionY, this.motionZ);
                this.worldObj.spawnParticle("flame", this.posX - 0.2D, this.posY + 0.2D, this.posZ - 0.2D, this.motionX , this.motionY, this.motionZ);
                this.worldObj.spawnParticle("flame", this.posX - 0.2D, this.posY - 0.1D, this.posZ - 0.2D, this.motionX , this.motionY, this.motionZ);
                this.worldObj.spawnParticle("flame", this.posX + 0.2D, this.posY + 0.2D, this.posZ + 0.2D, this.motionX , this.motionY, this.motionZ);
                this.worldObj.spawnParticle("flame", this.posX + 0.2D, this.posY - 0.2D, this.posZ + 0.2D, this.motionX , this.motionY, this.motionZ);
                this.worldObj.spawnParticle("flame", this.posX - 0.2D, this.posY + 0.2D, this.posZ - 0.2D, this.motionX , this.motionY, this.motionZ);
                this.worldObj.spawnParticle("flame", this.posX - 0.2D, this.posY - 0.2D, this.posZ - 0.2D, this.motionX , this.motionY, this.motionZ);
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        if (l == 1)
        {
            p_149734_1_.spawnParticle("smoke", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
            p_149734_1_.spawnParticle("flame", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 2)
        {
            p_149734_1_.spawnParticle("smoke", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
