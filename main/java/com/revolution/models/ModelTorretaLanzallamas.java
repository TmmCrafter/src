...
public class ModelTorretaLanzallamas extends ModelBase
{
  //fields
    ...
    ModelRenderer Conector;
    ModelRenderer Botella1;
    ModelRenderer Botella2;
  
  public ModelTorretaLanzallamas()
  {
    textureWidth = 128;
    textureHeight = 128;
      ...
      TorreCabeza1.addBox(0F, 0F, 0F, 8, 4, 12);
      ...
      TorreCanon1.addBox(0F, 0F, 0F, 1, 2, 2);
      TorreCanon1.setRotationPoint(-1.5F, -4F, -8F);
      ...
      TorreCanon2.addBox(0F, 0F, 0F, 2, 1, 2);
      TorreCanon2.setRotationPoint(-1F, -4.5F, -8F);
      ...
      TorreCanon3.addBox(0F, 0F, 0F, 1, 2, 2);
      TorreCanon3.setRotationPoint(0.5F, -4F, -8F);
      ...
      TorreCanon4.addBox(0F, 0F, 0F, 2, 1, 2);
      TorreCanon4.setRotationPoint(-1F, -2.5F, -8F);
      ...
      Soporte2 = new ModelRenderer(this, 70, 15);
      Soporte2.addBox(0F, 0F, 0F, 4, 10, 1);
      Soporte2.setRotationPoint(-2F, -1F, 3F);
      Soporte2.setTextureSize(64, 32);
      Soporte2.mirror = true;
      setRotation(Soporte2, -0.2617994F, 0F, 0F);
      ...
      Conector = new ModelRenderer(this, 50, 50);
      Conector.addBox(0F, 0F, 0F, 6, 1, 1);
      Conector.setRotationPoint(-3F, -4F, 6F);
      Conector.setTextureSize(128, 128);
      Conector.mirror = true;
      setRotation(Conector, 0F, 0F, 0F);
      Botella1 = new ModelRenderer(this, 50, 55);
      Botella1.addBox(0F, 0F, 0F, 4, 7, 4);
      Botella1.setRotationPoint(1F, -3F, 6F);
      Botella1.setTextureSize(128, 128);
      Botella1.mirror = true;
      setRotation(Botella1, 0F, 0F, 0F);
      Botella2 = new ModelRenderer(this, 50, 55);
      Botella2.addBox(0F, 0F, 0F, 4, 7, 4);
      Botella2.setRotationPoint(-5F, -3F, 6F);
      Botella2.setTextureSize(128, 128);
      Botella2.mirror = true;
      setRotation(Botella2, 0F, 0F, 0F);
  }
